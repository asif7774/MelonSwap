...
class HomeView extends Component {
    constructor(props){
        ...
        this.state = {
            username:'',
            basePoolCoins:[{name:'USDT',balance:-1,walletBalance:0,index:1,add:'0x1233ce9e6f492c12c4d76a248cb35db7ccff8c48',type:'baseToken'},{name:'DAI',balance:-1,walletBalance:0,index:2,add:'0x1416595fcdc0e03e06cec02f69446903664e1efb',type:'baseToken'},{name:'BUSD',balance:-1,walletBalance:0,index:0,add:'0x69d3c174a0e284c189a58fcfec43adc37737b681',type:'baseToken'},{name:'USDC',balance:-1,walletBalance:0,index:3,add:'0x7a3294500b45b4e9aa35d11f367a0f5042ab589a',type:'baseToken'},{name:'4ME',balance:-1,walletBalance:0,index:4,add:LP_TOKEN_ADD,type:'lpToken'}],
            metaPoolVaiCoins : [{name:'VAI',balance:0},{name:'BUSD',balance:0},{name:'USDT',balance:0},{name:'DAI',balance:0},{name:'USDC',balance:0}],
            secondaryCoin : [{name:'DAI',balance:-1,walletBalance:0,index:2,add:'0x1416595fcdc0e03e06cec02f69446903664e1efb',type:'baseToken'},{name:'USDC',balance:-1,walletBalance:0,index:3,add:'0x7a3294500b45b4e9aa35d11f367a0f5042ab589a',type:'baseToken'},{name:'BUSD',balance:-1,walletBalance:0,index:0,add:'0x69d3c174a0e284c189a58fcfec43adc37737b681',type:'baseToken'}],
            inputCoin : 'USDT',
            outPutCoin : 'DAI',
            ...
            case 0 :  contract = new web3.eth.Contract(CONTRACT_ABI_POOL, CONTRACT_ADDRESS_POOL);
                        ...
                        if(this.state.walletConnected ){
                            ...
                            for(let i=0;i<this.state.basePoolCoins.length;++i){
                                ...
                                val = new BigNumber(val).dividedBy(precision);
                                console.log(this.state.account,val);
